        ...
        ?><table class="wp-list-table widefat fixed posts" cellpadding="0">
            ...
            <tbody><?php
                ...
                foreach($groups as $headings){
                    ?><tr>
                        <td>
                            <a href="<?php echo admin_url('edit.php?post_type=site&page=wpauthority&tab=editgroup&id=' . $headings['id']); ?>"><strong><?php echo $headings['name']; ?></strong></a>
                            <div class="row-actions">
                                <span class="edit"><a href="<?php echo admin_url('edit.php?post_type=site&page=wpauthority&tab=editgroup&id=' . $headings['id']); ?>" title="Edit this item">Edit</a><?php
                                
                                if($headings['readonly'] == false){
                                    ?> | </span>
                                    <span class="trash">
                                        <a class="submitdelete" title="Delete Item" href="<?php echo admin_url('edit.php?post_type=site&page=wpauthority&metric_action=delete&id='.$headings['id']); ?>">Delete</a>
                                    </span><?php
                                } else {
                                    ?></span><?php
                                }
